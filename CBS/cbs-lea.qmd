...
## LEA-level Analysis Results Overview

The LEA-level APR asked LEAs to reflect on their site’s progress (via a review of their site level APRs) and subsequently self-assess their phase of growth and development (Visioning, Engaging, or Transforming) across the five CBSs. From Year 2 (2023–24) to Year 3 (2024–25), LEAs demonstrate a consistent shift away from Visioning and toward Engaging across all five strategies for Cohorts 1 and 2 combined, indicating that more LEAs see themselves moving from early planning into deeper implementation of the community schools approach. *(Note that LEAs were not asked to assess their progress on the CBSs in Year 1).*

In Year 3, most LEAs are in the Engaging phase for every CBS, with particularly strong concentrations in Shared Commitment, Understanding, and Priorities (72% Engaging) and Sustaining Staff and Resources (74% Engaging). Strategic Community Partnerships shows the largest share of Transforming in Year 3 (14%), suggesting that a subset of LEAs report deeper, more established practice in partnership development and alignment. Centering Community-Based Learning remains comparatively more concentrated in Visioning in Year 3 (37%) than the other strategies, indicating that many LEAs are still building the conditions—time, professional learning opportunities, staffing, schedules, and shared practice—needed to support their sites in fully integrating community-connected learning within the instructional core.

## COHORTS 1 to 3 in Year 3
